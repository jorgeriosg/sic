def numero_a_texto(n):
    '''
    Sacado de http://ingeniero.wahio.com/convertir-numeros-a-texto-python/
    Permite convertir números en un rango de 1 a 999 millones.
    '''
    lista=list(str(n))
    ...
    return ' '.join(orden).lstrip().rstrip()
